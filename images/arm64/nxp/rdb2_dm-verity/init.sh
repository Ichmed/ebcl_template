...
mkdir /verity-root-hash
mount -o ro /dev/mmcblk0p4 /verity-root-hash

veritysetup verify $root /dev/mmcblk0p3 --root-hash-file /verity-root-hash/root-hash
echo "verity check successfull, mounting sysroot"
veritysetup open $root verified-sysroot /dev/mmcblk0p3 --root-hash-file /verity-root-hash/root-hash
