...
verity: $(disc_image)
	@echo "Mounting image..."
	$(eval lo = $(shell sudo losetup -fP --show $(disc_image)))
	@echo "Creating hashes"
	mkdir root_hash
	sudo mount $(lo)p4 root_hash
	sudo bash -c "veritysetup format $(lo)p2 $(lo)p3 | sed -nr 's/Root hash:\s*(.*)/\1/p' > root_hash/root_hash"
	cat root_hash/root_hash
	sudo umount root_hash
	rmdir root_hash
	sudo losetup -d $(lo)
